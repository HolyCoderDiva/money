...
?>
<a href='#' class='show' rel='search'>Customer Lookup</a><br>
<div class="hidden search">
<form action="#" onsubmit="search();"><input type="text" name="find" id="find"><input type="submit"></form>
</div><div id='output'></div>
<?
showform($ID,$Key,$test_url);///////////////////////////////////////////////////////////// test url
...
echo "<form name='bigform' id='bigform' action='$url' method='post'>";
