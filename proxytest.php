...
$host = 'localhost'; $user = 'a0014046'; $pass = 'mermaid5!'; $dbname = 'data';
...
if (!empty($_REQUEST['action'])) // do we have an action?
{
   ...
   switch($_REQUEST['action'])
   {
      ...
      $OpenFile = fopen("tmc_test.log", "a"); // append latest data to log file
      ...
      $predata = "vendor_id=847952&vendor_pass=437861371&post_url=https://www.502011tr021731axxxsb.com/api/leadpost.aspx&lead_type_id=14&test_app=0&auto_redirect=0&accepted_terms=1&is_live=1&";
...
function LFSwap()
{
   ...
   $params = str_replace("income_type=D","income_type=BENEFITS",$params);
   $params = str_replace("income_type=S","income_type=BENEFITS",$params);
   $params = str_replace("income_type=U","income_type=BENEFITS",$params);
   $params = str_replace("income_type=O","income_type=BENEFITS",$params);
